...
M = [2     400    500*0.5     v_wind(1)  w_opt(1)   w_rated(1);
     4     400    1500*0.5    v_wind(2)  w_opt(2)   w_rated(2)]; 
...
%% PSS 
% prio  machine 2 - for mode1
%       machine 5 - for mode2
%       machine 3 - for mode3
%       machine 4 - for mode4
%       machine 1 - for mode4 
% Kpss = [0.15; 0.8; 0.5; 0.5; 0.8];
% Kpss = [0.15; 0.6; 0.15; 0.15; 0.15];
% % [0; 0; 0; 0; 0];
% T1 = [sqrt(0.01497); 0.07312 ; 0.06712; 0.08661; 0.08737];
% T2 = [sqrt(0.1493); 0.4373; 0.2741; 0.5458; 0.856];
% 
% T3 = [sqrt(0.01497); 0; 0; 0; 0];
% T4 = [sqrt(0.1493); 0; 0; 0; 0];
